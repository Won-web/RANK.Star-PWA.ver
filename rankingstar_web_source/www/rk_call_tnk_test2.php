...
if(!isset($checkCode) || $checkCode != $verifyCode) {
	...
	insert_point($mdUserName, $payPoint, '광고리워드','','','','','광고리워드','free');


	insert_point($mdUserName, $payPoint, '광고리워드','','','','','광고리워드','free','');


	insert_point($mb_id, $point, $content='', $rel_table='', $rel_id='', $rel_action='', $expire=0,$desc,$type,$amount='')
...
insert_callback_point($mdUserName, $payPoint, '광고리워드test','','','','','광고리워드test','free','');
