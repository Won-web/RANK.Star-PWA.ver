...
<title><?php echo lang('LBL_USER_ADD'); ?></title>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><?php echo lang('LBL_USER_ADD'); ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php echo lang('LBL_USER_ADD'); ?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <?php 
                ...
                echo form_open(BASE_URL.'user/adduser', $attr);
              ?>
              ...
              <div class="row">
                ...
                <div class="col-md-7">
                  <input type="submit" class="btn btn-primary" name="submit" value="<?php echo lang('BTN_ADD_USER'); ?>">
                </div>
              </div>
            </div>
            <!-- /.card-body -->
