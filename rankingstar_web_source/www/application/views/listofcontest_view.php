...
<script type="text/javascript">
  ...
  "oPaginate": {
            ...
            "columns": [
                ...
                null,
                {
                "orderable": false, "render":function(data,row){
			if(data == "열기") {
				return "<b style='color:blue;'>OPEN</b>";
			} else if(data == "닫기") {
				return "<b style='color:grey;'>CLOSE</b>";
			} else {
				return data;
			}
		}},
    ...
    //delete contest
    $(document).on('click','.deleteContest', function(e){
      var contestId = $(this).attr('data-id');
      e.preventDefault();
      $.confirm({
        title: '<?php echo lang('LBL_DELETE_CONTEST'); ?>',
        content: '<?php echo lang('LBL_DELETE_CONTEST_CONFIRMATION'); ?>',
        buttons: {
          confirm: {
