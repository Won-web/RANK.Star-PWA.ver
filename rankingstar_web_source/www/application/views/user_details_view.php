...
<title><?php echo lang('LBL_USER_DETAILS'); ?></title>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><?php echo lang('LBL_USER_DETAILS'); ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php echo lang('LBL_USER_DETAILS'); ?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="card">
            <div class="card-header">
              ...
              <!-- <a class="btn btn-warning" href="<?php //echo BASE_URL . "user/history/" . $userDetails['user_id']; ?>"><?php //echo lang('LBL_VIEW_HISTORY'); ?></a>  -->
                ...
                <a href="<?php echo BASE_URL . "user"; ?>" class="btn btn-primary"><?php echo lang('BTN_BACK'); ?></a>
              <?php endif; ?>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              ...
              <div class="alert alert-danger alert-dismissible">
                ...
                <?php 
                    ...
                    echo form_open(BASE_URL.'user/edituser', $attr);
                ?>
                <?php 
                    $delete = array('id'=>'deleteUserToUnsubscribe');
                    echo form_open(BASE_URL.'user/deleteUserToUnsubscribe', $delete);
                ?>
...
<!-- 
                ...
                <div class="row">
                    <div class="col-md-8">
                    <?php if ($userData['user_type'] === "admin"): ?>                      
                      <button type="button" class="btn btn-danger deleteUser" name="deletebtn"><?php echo lang('BTN_DELETE_USER'); ?></button>
                    <?php endif; ?>
                    </div>
                    <div class="col-md-4">
                    <?php if ($userData['user_type'] === "admin"): ?>
                        <button type="button" class="btn btn-primary editUser float-right" name="editbutton"><?php echo lang('BTN_UPDATE_USER'); ?></button>
                    <?php endif; ?>
                    </div>
                </div>
            </div>
        ...
        $.confirm({
          ...
          buttons: {
            confirm: {
              ...
              action: function () {
                $.ajax({
                  url: "<?php echo base_url("user/deleteUserToUnsubscribe") ?>",
                  type: 'POST',
                  data: {
