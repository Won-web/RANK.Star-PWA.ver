...
<title><?php echo lang('ADMIN_MANAGER_MANAGEMENT'); ?></title>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><?php echo lang('ADMIN_MANAGER_MANAGEMENT'); ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo BASE_URL . "dashboard"; ?>"><?php echo lang('LBL_HOME'); ?></a></li>
              <li class="breadcrumb-item active"><?php echo lang('ADMIN_MANAGER_MANAGEMENT'); ?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title"><?php echo lang('LBL_ADMIN_MANAGER_LIST'); ?></h3>
              <?php if ($userData['user_type'] === "admin"): ?>
                <a class="btn btn-primary" style="float:right;" href="<?php echo BASE_URL . "manager/adduser"; ?>"><?php echo lang('BTN_ADD_MANAGER_ADMIN'); ?></a>
              <?php endif; ?>
        ...
        var pageNumber =  1;
          ...
          if(page_no){
            ...
            table = $('#userlist').DataTable({
                ...
                "ajax": {
                  url : "<?php echo base_url("manager/userlist") ?>",
                  type : 'POST',
