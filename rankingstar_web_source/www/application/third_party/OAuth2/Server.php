    ...
    UserInfoControllerInterface
{
     ...
     * @param $is_authorized
     * TRUE or FALSE depending on whether the user  authorized theaccess.
     * @param $user_id
     ...
     * @ingroup oauth2_section_4
     */
    public function handleAuthorizeRequest(RequestInterface $request , $user_id = null , ResponseInterface $response = null, $is_authorized = TRUE )
    {
        $this->response = is_null($response) ? new Response() : $response;
