...
class AuthorizeController implements AuthorizeControllerInterface
{
    ...
    public function handleAuthorizeRequest(RequestInterface $request,  $response, $is_authorized, $user_id = null)
    {
        ...
        // $auth_code = $uri_params['query']['code'];
        // echo $auth_code;
    ...
    public function validateAuthorizeRequest(RequestInterface $request, ResponseInterface $response)
    {
        ...
        //default state and response_type set
        $state = "default_state";
        $response_type = "code";
