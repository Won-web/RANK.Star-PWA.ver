...
<style>
	.anchor{background-color:#D6DDE1!important;}
</style>
...
<section id="anc_sitfrm_cate" style="display:none">
...
<section id="anc_sitfrm_ini">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="it_1">쿠폰상품 여부</label></th>
            <td colspan="2">
                <?php echo help("쿠폰상품일 경우에만 체크 하세요. 결제완료 후 바로 포인트지급이 완료 됩니다."); ?>
                <input type="checkbox" name="it_1" value="1"  id="it_1" <?php echo $it['it_1'] == '1' ? 'checked=checked':'' ?> class="frm_input required" size="1">
            </td>
        </tr>
        <tr>
