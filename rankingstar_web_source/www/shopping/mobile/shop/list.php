...
<style>
#MyOrderBtn{padding:10px;text-align:right;}
#MyOrderBtn .btn{display:inline-block;width:auto;padding-left:20px;padding-right:20px;}
</style>
<div id="MyOrderBtn">
<a href="<?php echo G5_SHOP_URL?>/mypage.php" class="btn_cart_op btn_submit btn" style="color:#fff;">나의 주문내역</a>
</div>
