...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="orderlist<?php echo ' '.$bg; ?>">
        ...
        <td headers="th_ordnum" class="td_odrnum2" rowspan="2" colspan="2">
            ...
            <a href="#non" onclick="window.open('./orderprintresult2.php?od_id=<?=$row['od_id']?>&ct_status=<?=$row['od_status']?>', 'google', 'width=500,height=500');"><?php echo $disp_od_id; ?></a>
            <?php echo $od_mobile; ?>
            <?php echo $od_paytype; ?>
			...
			<?php
				for($i2=0; $row_view=sql_fetch_array($result_item); $i2++) {
...
<?php } ?>
     <span>주문상태에서만 삭제가 가능합니다.</span> <input type="submit" value="선택삭제" class="btn_submit" onclick="document.pressed=this.value">
</div>
