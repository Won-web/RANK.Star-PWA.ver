...
<section id="anc_sodr_list">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        for($i=0; $row=sql_fetch_array($result); $i++) {
            ...
            $o_item = "select it_1 from g5_shop_item where it_id = '{$row[it_id]}' ";
			$item = sql_fetch($o_item);
            ...
            <tr>
                ...
                <td class="td_left">
                    ...
                    <input type="text" name="it_1" value="<?php echo $item['it_1']?>">
                    
                    <?php
					// 입금된 주문에 포인트를 적립한다.
					save_order_point("입금",$item[it_1],$ct_price['stotal']);
					?>
                </td>
    ...
    <div class="btn_list02 btn_list" id="btn-status">
        <p>
    ...
    <script>
	   $(document).ready(function(){
		   $("#btn-status input[type=submit]").not(".cancel").attr("disabled","disabled");
	   });
    </script>
    <style>
	    input[type=submit]:disabled{opacity:.8;cursor: not-allowed;}
	   </style>
    <?php endif?>-->
    ...
    <div class="local_desc01 local_desc">
        ...
        <p>* <strong style="color:red">취소</strong>한 상품은 다시 돌릴 수 없습니다</p>
    </div>
