...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        <th scope="col">순위</th>
        <th scope="col">상품명</th>
        <th scope="col"><a href="<?php echo title_sort("ct_status_0",1)."&amp;$qstr1"; ?>">매출</a></th>
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++)
    {
        ...
        <tr class="<?php echo $bg; ?>">
            ...
            <td class="td_left">
	            <a href="<?php echo $href; ?>"><?php echo get_it_image($row['it_id'], 50, 50); ?> <?php echo cut_str($row['it_name'],30); ?> <br>판매가: <span style="color:#999;font-style:italic"><?php echo number_format($row['it_price']); ?>원</span> | 구분: <span style="color:#999;font-style:italic"><?php echo $row['it_1'] == 1 ? '쿠폰상품' : '일반상품'?></span> | 상태 : <span style="color:#999;font-style:italic"><?php echo $row['it_use'] == 1 ? '<span style=color:blue>판매중</span>' : '<span style=color:red>중지</span>'?></span></a>
            </td>
            <td class="td_num"><?php echo number_format($row['ct_status_6'] * $row['it_price']); ?></td>
