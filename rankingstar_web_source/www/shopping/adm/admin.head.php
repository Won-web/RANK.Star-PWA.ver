...
<header id="hd">
    ...
    <div id="hd_top">
       ...
       <div id="logo"><a href="<?php echo correct_goto_url(G5_ADMIN_URL); ?>"><img src="<?php echo G5_ADMIN_URL ?>/img/logo_white.svg" alt="<?php echo $config['cf_title'] ?> 관리자" style="height:20px"></a></div>
        ...
        <div id="tnb">
            <ul>
                ...
                <li class="tnb_li"><a href="http://ranking-star.com/admin/dashboard" class="tnb_service">어플관리자</a></li>
