...
#n1589542534{display:none!important}

<?php if($_REQUEST['test'] == 'y'):?>
#n1589542534{display:block!important}
<?php endif?>
</style>
...
$G5_THEME_IMG_URL = G5_THEME_IMG_URL;
$i = 0;
foreach((array) $list as $row){
   ...
   if($i % $this->list_mod == 0)
    ...
    echo "<li class=\"sct_li{$li_clear}\" id=\"n{$row['it_id']}\" ><div class=\"li_wr is_view_type_list\">\n";

    if ($this->href) {
        echo "<span class='item-badge'><img src=\"{$G5_THEME_IMG_URL}/star-wb.png\" style='position:relative;top:3px'>  +{$row['it_point']}</span><div class=\"sct_img\"><a href=\"{$item_link_href}\">\n";
    }
