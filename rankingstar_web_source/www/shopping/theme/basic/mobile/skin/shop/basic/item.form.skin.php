...
<input type="hidden" name="it_1" value="<?php echo $it['it_1']?>">
        ...
        <div class="sit_ov_wr">
            ...
            <div class="sit_ov_tbl">
                ...
                */
                ...
                <?php if($it['it_1'] != '1'): //쿠폰일경우는 출력 하지 않음 ?>
                <tr>
...
<div id="btn_option">
    <div class="sl_option">
        ...
        <div id="sit_tot_price" style="font-size:1.25em!important;font-weight:bold;"></div>
        
        <style>
	        #sit_tot_price strong{font-size:1.25em!important;font-weight:bold;color:#000}
	       </style>
        <?php } ?>
        ...
        <div id="sit_ov_btn">
            ...
            <input type="submit" onclick="document.pressed=this.value;" value="바로구매" id="sit_btn_buy" class="btn_submit" style="width:100%;">
            <?php } ?>
...
<div id="sit_tab">
    <ul class="tab_con">
        ...
        <!-- 배송정보 시작 { -->
        <li id="sit_dvex">
            <h2><?php echo $it['it_1'] == '1' ? '환불정보':'배송/교환정보'?></h2>
            
            <?php if($it['it_1'] == 1):?>
            <div id="sit_dvr">
                <h3>쿠폰 환불안내</h3>
                <p>쿠폰 환불안내에 관한 문구 보내주세요</p>
            </div>
