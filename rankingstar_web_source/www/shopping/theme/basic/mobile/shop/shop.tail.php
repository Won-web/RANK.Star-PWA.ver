...
<div id="ft">
	...
	<p style="padding:5px;background-color:#333;color:#fff;font-size:.6rem">해당 홈페이지 내 반품, 환불, 민원에 대한 책임은 <?php echo $default['de_admin_company_name']; ?>에서 지고 있음을 알려드립니다. 담당자 : 허성훈  (rankingstar.2020@gmail.com )</p>
    <p>
